<?php 
    ...
    $news = $news[$id];
    if($news['NewsPic'])
        $scr = "images/noticias/".$news['NewsId'].".jpg";
    else
        $scr = "";
    		...
    		<div class="row">
    			<div class="span12">
    				<ul class="breadcrumb">
    					...
    					<li class="active"><a href="#">Noticia</a></li>
    				</ul>
    			</div>
    		</div>
    	</div>
    				...
    				<div class="row">    					                   
    					<div class="span9 width-news-detail">
    						<div class="lined">
		    					...
		    					<div class="meta-data">
		    						<?php echo f_fecha($news['dateAdd']) ?>
								</div>
		    					<span class="bolded-line"></span>
		    				</div>
		    				<p><?php echo !empty($scr)? '<img class="img-principal" src="'.$scr.'" title="'.$news['NewsTitle'].'" />' : '' ?></p>
