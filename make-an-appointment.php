    		...
    		<div class="row">
    			<div class="span12">
    				<ul class="breadcrumb">
    					...
    					<li class="active"><a href="make-an-appointment.html">Make an Appointment</a></li>
    				</ul>
    			</div>
    		</div>
    	</div>
    ...
    <div class="main-content">
    		...
    		<div class="row">
    			<div class="span3">
				    ...
				    <div class="left sidebar">
			    		...
			    		<div class="opening-time sidebar-item visible-desktop">
		                ...
		                <div class="sidebar-item">
		                	<div class="lined">
		                		<h2><span class="light">OUR</span> ADDRESS</h2>
							...
							Phone: <strong class="black-clr">(516) 565-9700</strong> <br />
							Fax: <strong class="black-clr">(516) 565-9701</strong> <br />
							Mail: <strong class="black-clr">info@hairpress.com</strong> <br />
    	...
    	nulla ed leo malesuada commodo bibendum orci vi verra. Donec suscipit vehicula turpis sed lutpat.</p>
    					...
    					<form action="#" class="form appointment">
    						<div class="row">
    							<div class="span3">
    								<label for="inpt-name">First and Last name<span class="theme-clr">*</span></label>
    								<input type="text" name="inpt-name" value="" id="inpt-name" class="span3" />
    							</div>
    							<div class="span3">
    								<label for="inpt-phone">Phone Number<span class="theme-clr">*</span></label>
    								<input type="tel" name="inpt-name" value="" id="inpt-phone" class="span3" />
    							</div>
    							<div class="span3">
    								<label for="inpt-email">E-mail Address</label>
    						...
    						<div class="row">
    							<div class="span9">
    								<label for="txtarea">Type here if you have some special requirements<span class="theme-clr">*</span></label>
