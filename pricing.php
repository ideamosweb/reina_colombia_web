...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title>Hairpress, HTML template - Our Prices</title>
    		...
    		<div class="row">
    			<div class="span12">
    				<ul class="breadcrumb">
    					...
    					<li><a href="services-pricing.html">Services &amp; Pricing</a> <span class="divider"></span></li>
    					<li class="active"><a href="pricing.html">Our Prices</a></li>
    				</ul>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="container">
    		<div class="row">
    				...
    				<div class="left sidebar">
    					<div class="sidebar-item menu">
    						...
    						<ul class="nav nav-pills nav-stacked">
    							<li><a href="services-pricing.html">Our Services</a></li>
    							<li><a href="features.html">Features of the Theme</a></li>
    			...
    			<div class="span9">
    				...
    				<div class="lined">
    					<h2><span class="light">PRICING</span> TABLE</h2>
    				...
    				<table class="table">
    					<thead>
    						<tr>
    							<th>Service</th>
    							<th class="align-center"><span class="icon icons-him"></span> For Him</th>
    							<th class="align-center"><span class="icon icons-her"></span> For Her</th>
    							<th class="align-center"><span class="icon icons-child"></span> For Children</th>
							</tr>
    					</thead>
    					<tbody>
    						<tr>
    				...
    				<div class="lined">
    					<h2><span class="light">PRICING</span> TABLE WITHOUT CHILDREN</h2>
    					<h5>How much our services cost</h5>
    					<span class="bolded-line"></span>
    				</div>
